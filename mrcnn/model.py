...
def compute_backbone_shapes(config, image_shape):
    ...
    assert config.BACKBONE in ["resnet50", "resnet101", "resnet152", "inception", "vgg", "mobilenetv1", "mobilenetv2"]
    return np.array(
...
def InceptionResNetV2(input_image, architecture, train_bn=True):
    ...
    C1 = x = conv2d_bn(x, 192, 3, padding='valid')
    x = KL.MaxPooling2D(3, strides=2)(x)
...
def build_fpn_mask_graph(rois, feature_maps, image_meta,
                         pool_size, num_classes, train_bn=True, backbone="resnet101", mask_shape=(28, 28)):
    ...
    assert backbone in ["resnet50", "resnet101", "resnet152", "inception", "vgg", "mobilenetv1", "mobilenetv2"]
